      ...
      <div className="container">
        <div className='md:flex items-center'>
          ...
          <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
            ...
            />
            <motion.img src={cylinderImage.src} alt="Cylinder" height={220} width={220} className='hidden md:block -top-8 -left-32 md:absolute'
            style={{
              translateY: translateY,
            }}
            />
            <motion.img src={noodleImage.src} alt="Noodle" height={220} width={220} className='hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]'
            style={{
              rotate: 30,
              translateY: translateY,
            }}
